...
namespace StudentManagementSystem.Presentation.Pages.Student.Schedule;
...
public sealed class IndexModel(IAcademicService academicService) : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(CancellationToken cancellationToken)
    {
        ...
        ScheduleSlots = await academicService.GetScheduleSlotsAsync(SemesterId, null, null, studentId, cancellationToken);
